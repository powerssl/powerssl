 ...
 * @const
 */
proto.powerssl.api.v1.ListCertificateIssuesResponse.repeatedFields_ = [1];
...
proto.powerssl.api.v1.ListCertificateIssuesResponse.prototype.getCertificateIssuesList = function() {
  return /** @type{!Array<!proto.powerssl.api.v1.CertificateIssue>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.powerssl.api.v1.CertificateIssue, 1));
};
...
proto.powerssl.api.v1.ListCertificateIssuesResponse.prototype.addCertificateIssues = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.powerssl.api.v1.CertificateIssue, opt_index);
};
 ...
 * @return {string}
 */
proto.powerssl.api.v1.ListCertificateIssuesResponse.prototype.getNextPageToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.powerssl.api.v1.ListCertificateIssuesResponse.prototype.setNextPageToken = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.powerssl.api.v1.UpdateCertificateIssueRequest.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.powerssl.api.v1.UpdateCertificateIssueRequest.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
