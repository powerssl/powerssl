...
COPY --from=builder /powerssl.io/bin/powerctl /powerssl.io/bin/powerssl-apiserver /powerssl.io/bin/powerssl-controller /powerssl.io/bin/powerssl-integration-acme /powerssl.io/bin/powerssl-integration-cloudflare /usr/local/bin/
