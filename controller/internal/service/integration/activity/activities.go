...
func GetByAPIActivity(activity *apiv1.Activity) (*Activity, error) {
...
func (a *activities) GetByAPIActivity(activity *apiv1.Activity) (*Activity, error) {
	return a.Get(activity.GetToken())
}
