...
controller: go run powerssl.io/cmd/powerssl-controller serve --addr localhost:5300 --metrics-addr localhost:5390
signer: go run powerssl.io/cmd/powerssl-signer serve --addr localhost:5400 --metrics-addr localhost:5490
integration-acme: sh -c "sleep 0.1 && go run powerssl.io/cmd/powerssl-integration-acme run --addr localhost:5300 --metrics-addr localhost:5590"
