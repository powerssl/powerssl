...
func (*ACMEAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{0}
}
...
func (*CreateACMEAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{1}
}
...
func (*DeleteACMEAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{2}
}
...
func (*GetACMEAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{3}
}
...
func (*ListACMEAccountsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{4}
}
...
func (*ListACMEAccountsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{5}
}
...
func (*UpdateACMEAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_account_5d9befeb199f7ce2, []int{6}
}
...
func init() {
	proto.RegisterFile("powerssl/apiserver/v1/acme_account.proto", fileDescriptor_acme_account_5d9befeb199f7ce2)
}

var fileDescriptor_acme_account_5d9befeb199f7ce2 = []byte{
	// 745 bytes of a gzipped FileDescriptorProto
	,
}
