...
func newCmdServe() *cobra.Command {
	...
	cmd.Flags().String("jwks-insecure-skip-tls-verify", "", "Skip JWKS TLS verification")
	cmd.Flags().String("jwks-server-name-override", "", "JWKS Server Name override")
	...
	cmdutil.Must(viper.BindPFlag("jwks.insecure-skip-tls-verify", cmd.Flags().Lookup("jwks-insecure-skip-tls-verify")))
	cmdutil.Must(viper.BindPFlag("jwks.server-name-override", cmd.Flags().Lookup("jwks-server-name-override")))
