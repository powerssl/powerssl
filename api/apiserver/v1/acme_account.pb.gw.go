...
func local_request_ACMEAccountService_Create_0(ctx context.Context, marshaler runtime.Marshaler, server ACMEAccountServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateACMEAccountRequest
	var metadata runtime.ServerMetadata
...
func local_request_ACMEAccountService_Delete_0(ctx context.Context, marshaler runtime.Marshaler, server ACMEAccountServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteACMEAccountRequest
	var metadata runtime.ServerMetadata
...
func local_request_ACMEAccountService_Get_0(ctx context.Context, marshaler runtime.Marshaler, server ACMEAccountServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetACMEAccountRequest
	var metadata runtime.ServerMetadata
...
func local_request_ACMEAccountService_List_0(ctx context.Context, marshaler runtime.Marshaler, server ACMEAccountServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListACMEAccountsRequest
	var metadata runtime.ServerMetadata
...
func local_request_ACMEAccountService_Update_0(ctx context.Context, marshaler runtime.Marshaler, server ACMEAccountServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateACMEAccountRequest
	var metadata runtime.ServerMetadata
...
// RegisterACMEAccountServiceHandlerServer registers the http handlers for service ACMEAccountService to "mux".
// UnaryRPC     :call ACMEAccountServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterACMEAccountServiceHandlerFromEndpoint instead.
func RegisterACMEAccountServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ACMEAccountServiceServer) error {
	...
	mux.Handle("POST", pattern_ACMEAccountService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Create", runtime.WithHTTPPathPattern("/v1/{parent=acmeServers/*}/acmeAccounts"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ACMEAccountService_Create_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("DELETE", pattern_ACMEAccountService_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Delete", runtime.WithHTTPPathPattern("/v1/{name=acmeServers/*/acmeAccounts/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ACMEAccountService_Delete_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_ACMEAccountService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Get", runtime.WithHTTPPathPattern("/v1/{name=acmeServers/*/acmeAccounts/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ACMEAccountService_Get_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_ACMEAccountService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/List", runtime.WithHTTPPathPattern("/v1/{parent=acmeServers/*}/acmeAccounts"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ACMEAccountService_List_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("PUT", pattern_ACMEAccountService_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Update", runtime.WithHTTPPathPattern("/v1/{name=acmeServers/*/acmeAccounts/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ACMEAccountService_Update_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
func RegisterACMEAccountServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ACMEAccountServiceClient) error {
	...
	mux.Handle("POST", pattern_ACMEAccountService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Create", runtime.WithHTTPPathPattern("/v1/{parent=acmeServers/*}/acmeAccounts"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ACMEAccountService_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Delete", runtime.WithHTTPPathPattern("/v1/{name=acmeServers/*/acmeAccounts/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ACMEAccountService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Get", runtime.WithHTTPPathPattern("/v1/{name=acmeServers/*/acmeAccounts/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ACMEAccountService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/List", runtime.WithHTTPPathPattern("/v1/{parent=acmeServers/*}/acmeAccounts"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_ACMEAccountService_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/powerssl.apiserver.v1.ACMEAccountService/Update", runtime.WithHTTPPathPattern("/v1/{name=acmeServers/*/acmeAccounts/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
