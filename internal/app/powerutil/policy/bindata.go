...
func powersslApiserverHcl() (*asset, error) {
	...
	info := bindataFileInfo{name: "powerssl-apiserver.hcl", size: 122, mode: os.FileMode(420), modTime: time.Unix(1551818438, 0)}
...
func powersslControllerHcl() (*asset, error) {
	...
	info := bindataFileInfo{name: "powerssl-controller.hcl", size: 69, mode: os.FileMode(420), modTime: time.Unix(1551818441, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func powersslSignerHcl() (*asset, error) {
	...
	info := bindataFileInfo{name: "powerssl-signer.hcl", size: 65, mode: os.FileMode(420), modTime: time.Unix(1551818444, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
