...
func (*ACMEServer) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{0}
}
...
func (*CreateACMEServerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{1}
}
...
func (*DeleteACMEServerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{2}
}
...
func (*GetACMEServerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{3}
}
...
func (*ListACMEServersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{4}
}
...
func (*ListACMEServersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{5}
}
...
func (*UpdateACMEServerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_acme_server_7389aa9c45c3ca8c, []int{6}
}
...
func init() {
	proto.RegisterFile("powerssl/apiserver/v1/acme_server.proto", fileDescriptor_acme_server_7389aa9c45c3ca8c)
}

var fileDescriptor_acme_server_7389aa9c45c3ca8c = []byte{
	...
	,
}
